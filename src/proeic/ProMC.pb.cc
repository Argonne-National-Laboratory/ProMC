...
void protobuf_AssignDesc_ProMC_2eproto() {
  ...
  static const int ProMCEvent_Event_offsets_[18] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProMCEvent_Event, x_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProMCEvent_Event, q2_),
  ...
  static const int ProMCEvent_Particles_offsets_[19] = {
...
void protobuf_AddDesc_ProMC_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013ProMC.proto\022\005promc\"\347\005\n\nProMCEvent\022&\n\005e"
    ...
    "ha_QCD\030\r \001(\002\022\016\n\006Weight\030\016 \001(\001\022\t\n\001X\030\017 \001(\002\022"
    "\n\n\002Q2\030\020 \001(\002\022\r\n\005fdata\030\021 \003(\002\022\r\n\005idata\030\022 \003("
    "\022\032\352\002\n\tParticles\022\016\n\002id\030\001 \003(\rB\002\020\001\022\022\n\006pdg_i"
    "d\030\002 \003(\021B\002\020\001\022\022\n\006status\030\003 \003(\rB\002\020\001\022\020\n\004mass\030"
    "\004 \003(\002B\002\020\001\022\016\n\002Px\030\005 \003(\002B\002\020\001\022\016\n\002Py\030\006 \003(\002B\002\020"
    "\001\022\016\n\002Pz\030\007 \003(\002B\002\020\001\022\023\n\007mother1\030\010 \003(\rB\002\020\001\022\023"
    "\n\007mother2\030\t \003(\rB\002\020\001\022\025\n\tdaughter1\030\n \003(\rB\002"
    "\020\001\022\025\n\tdaughter2\030\013 \003(\rB\002\020\001\022\023\n\007barcode\030\014 \003"
    "(\021B\002\020\001\022\r\n\001X\030\r \003(\002B\002\020\001\022\r\n\001Y\030\016 \003(\002B\002\020\001\022\r\n\001"
    "Z\030\017 \003(\002B\002\020\001\022\r\n\001T\030\020 \003(\002B\002\020\001\022\022\n\006weight\030\021 \003"
    "(\002B\002\020\001\022\022\n\006charge\030\022 \003(\021B\002\020\001\022\022\n\006energy\030\023 \003"
    "(\002B\002\020\001B\022\n\tproeic.ioB\005ProMC", 786);
...
const int ProMCEvent_Event::kXFieldNumber;
const int ProMCEvent_Event::kQ2FieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        ...
        if (input->ExpectTag(125)) goto parse_X;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(133)) goto parse_Q2;
        break;
      }
      ...
      case 16: {
        ...
        if (input->ExpectTag(141)) goto parse_fdata;
        break;
      }
      ...
      case 17: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_fdata:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 2, 141, input, this->mutable_fdata())));
        ...
        if (input->ExpectTag(141)) goto parse_fdata;
        if (input->ExpectTag(144)) goto parse_idata;
        break;
      }
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_idata:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                 ...
                 2, 144, input, this->mutable_idata())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
...
void ProMCEvent_Event::SerializeWithCachedSizes(
  ...
  // optional float X = 15;
  if (has_x()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(15, this->x(), output);
  }

  // optional float Q2 = 16;
  if (has_q2()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(16, this->q2(), output);
  }

  // repeated float fdata = 17;
  for (int i = 0; i < this->fdata_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(
      17, this->fdata(i), output);
  }

  // repeated sint64 idata = 18;
  for (int i = 0; i < this->idata_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt64(
      18, this->idata(i), output);
  }
...
::google::protobuf::uint8* ProMCEvent_Event::SerializeWithCachedSizesToArray(
  ...
  // optional float X = 15;
  if (has_x()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(15, this->x(), target);
  }

  // optional float Q2 = 16;
  if (has_q2()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(16, this->q2(), target);
  }

  // repeated float fdata = 17;
  for (int i = 0; i < this->fdata_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteFloatToArray(17, this->fdata(i), target);
  }

  // repeated sint64 idata = 18;
  for (int i = 0; i < this->idata_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteSInt64ToArray(18, this->idata(i), target);
  }
...
int ProMCEvent_Event::ByteSize() const {
  ...
  // repeated float fdata = 17;
  {
    ...
    total_size += 2 * this->fdata_size() + data_size;
  }
  ...
  // repeated sint64 idata = 18;
  {
    ...
    total_size += 2 * this->idata_size() + data_size;
  }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 18: {
        ...
        if (input->ExpectTag(154)) goto parse_energy;
        break;
      }
      ...
      case 19: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_energy:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 2, 154, input, this->mutable_energy())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectAtEnd()) return true;
...
::google::protobuf::uint8* ProMCEvent_Particles::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->mass_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteFloatNoTagToArray(this->mass(i), target);
  }
  ...
  for (int i = 0; i < this->energy_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteFloatNoTagToArray(this->energy(i), target);
  }
