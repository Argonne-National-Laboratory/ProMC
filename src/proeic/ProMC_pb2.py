...
_PROMCEVENT_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='X', full_name='promc.ProMCEvent.Event.X', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Q2', full_name='promc.ProMCEvent.Event.Q2', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fdata', full_name='promc.ProMCEvent.Event.fdata', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='idata', full_name='promc.ProMCEvent.Event.idata', index=17,
...
_PROMCEVENT_PARTICLES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='energy', full_name='promc.ProMCEvent.Particles.energy', index=18,
